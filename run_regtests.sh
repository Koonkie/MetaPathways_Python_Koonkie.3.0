...
SAMPLE=B1
#SAMPLE=beaver
echo python   MetaPathways.py -i regtests/input -o regtests/output -s ${SAMPLE}  -p regtests/template_param.txt -c regtests/template_config.txt -v
python  MetaPathways.py -i regtests/input -o regtests/output -s ${SAMPLE}  -p regtests/template_param.txt -c regtests/template_config.txt -v
